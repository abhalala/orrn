...
import { dimensionsSchema } from "@orrn/api/routers/die"; // we might need to export this properly or duplicate type
      ...
      Papa.parse(file, {
        ...
        complete: (results) => {
          const parsedData = results.data.map((row: any) => ({
            ...
            dimensions: {
              widthMm: Number(row.dimensionsWidthMm) || undefined,
              heightMm: Number(row.dimensionsHeightMm) || undefined,
              thicknessMm: Number(row.dimensionsThicknessMm) || undefined,
            },
            notes: row.notes || "",
