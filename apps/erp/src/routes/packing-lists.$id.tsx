...
import type { PLSnapshot } from "@orrn/web-shared/lib/packingListPdf";
...
function PackingListDetailComponent() {
  ...
  async function handlePdf() {
    setPdfPending(true);
    try {
      const { downloadPackingListPdf } = await import("@orrn/web-shared/lib/packingListPdf");
  ...
  async function handleXlsx() {
    setXlsxPending(true);
    try {
      const { downloadPackingListXlsx } = await import("@orrn/web-shared/lib/packingListXlsx");
