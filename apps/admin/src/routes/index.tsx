    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center p-4 bg-[#0b0f1a]">
      ...
      <div className="w-full max-w-md space-y-6">
        <div className="flex flex-col items-center gap-3 mb-6">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#5B6CFF] to-[#22D3EE] shadow-lg border border-white/10">
            <span className="text-3xl font-black text-white">O</span>
          </div>
          <div className="text-center">
            <h2 className="text-sm font-bold tracking-[0.25em] text-[#f5f7ff] font-mono">ORRN SYSTEM CORES</h2>
